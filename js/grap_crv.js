...
async function main() {
    ...
    const rewardPoolAddr = "0xEe776E691EA8F0A1AB93F541C6D1e1d78A7e584b";
    ...
    const prices = await lookUpPrices(["curve-dao-token", "ethereum", "grap-finance"]);
    // const stakingTokenPrice = prices["compound-governance-token"].usd;
    const stakingTokenPrice = prices["curve-dao-token"].usd;
